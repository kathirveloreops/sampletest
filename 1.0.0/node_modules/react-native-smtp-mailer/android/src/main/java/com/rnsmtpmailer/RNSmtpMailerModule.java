    ...
    public void sendMail(final ReadableMap obj, final Promise promise) {
        AsyncTask.execute(new Runnable() {
            ...
            ReadableArray bcc = obj.hasKey("bcc") ? obj.getArray("bcc") : null;
             ReadableArray cc = obj.hasKey("cc") ? obj.getArray("cc") : null;
            ...
            public void run() {
                try {
                    ...
                    sender.sendMail(subject, body, username, fromName, replyToAddress, recipients, bcc,cc, attachmentPaths, attachmentNames);
...
class MailSender extends javax.mail.Authenticator {
    ...
    public synchronized void sendMail(String subject, String body, String sender, String senderAlias, String replyToAddress, String recipients, ReadableArray bcc,ReadableArray cc,
        ...
        if (bcc != null) {
         ...
         if (cc != null) {
            for (int i = 0; i < cc.size(); i++) {
                message.addRecipients(Message.RecipientType.CC, cc.getString(i));
            }
        }
